...
class ConvNeXt(nn.Module):
    ...
    def __init__(self, in_chans=3, num_classes=1000, 
                 ...
                 layer_scale_init_value=1e-6, head_init_scale=1., out_indices = None
                 ):
        super().__init__()
...
class ConvNextBaseModel(BaseModule):
    def __init__(self, pretrained=True, in_22k=True, **kwargs):
        super(ConvNextBaseModel, self).__init__()
        self.model = convnext_base(pretrained = pretrained, in_22k = in_22k, **kwargs)
