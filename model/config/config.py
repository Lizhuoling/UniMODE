...
def get_cfg_defaults(cfg):
    ...
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.BACKBONE_PRETRAIN = True
    ...
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.LID = False
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.MUTUAL_INFO_INPAINT = False
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.PTS_PAINT_CAM = False
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.CAM_PAINT_PTS = False
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.LLS_SPARSE = 5e-4
    ...
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.HEAD.D_BOUND = [0.1, 230, 1.8]
    ...
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL = CN()
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.USE_CENTER_PROPOSAL = False
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.FOCAL_DECOUPLE = False
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.VIRTUAL_FOCAL_Y = 512.0
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.PROPOSAL_NUMBER = 100
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.OBJ_LOSS_WEIGHT = 1.0
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.DEPTH_LOSS_WEIGHT = 1.0
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.OFFSET_LOSS_WEIGHT = 1.0
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.PROPOSAL_CONF_THRE = 0.3
    cfg.MODEL.DETECTOR3D.CENTER_PROPOSAL.ADAPT_LN = False
