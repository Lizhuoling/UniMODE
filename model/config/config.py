...
def get_cfg_defaults(cfg):
    ...
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.LID_DEPTH = False
    ...
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.HEAD.DET_2D_L1_WEIGHT = 5.0
    cfg.MODEL.DETECTOR3D.TRANSFORMER_DETECTOR.HEAD.DET_2D_GIOU_WEIGHT = 2.0
