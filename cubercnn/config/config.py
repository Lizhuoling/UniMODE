...
def get_cfg_defaults(cfg):
    ...
    cfg.MODEL.DETECTOR3D.PETR.CENTER_PROPOSAL.ADAPTIVE_BEV_SIZE = False
    cfg.MODEL.DETECTOR3D.PETR.CENTER_PROPOSAL.PROPOSAL_CONF_THRE = 0.3
    cfg.MODEL.DETECTOR3D.PETR.CENTER_PROPOSAL.ADAPT_VALID_PROPOSAL_MIN_NUM = 2
    cfg.MODEL.DETECTOR3D.PETR.CENTER_PROPOSAL.BEV_RANGE_EXTEND_PARAM = 0.2
